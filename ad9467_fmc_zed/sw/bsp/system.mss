...
BEGIN PROCESSOR
 ...
 PARAMETER compiler_flags = -O2 -c -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_ad9467
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_ad9467_dma
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = dm_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.3
 PARAMETER HW_INSTANCE = dm_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.3
 PARAMETER HW_INSTANCE = dm_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = mmult_accel_1_if
END
